...
【格局稀有度——固定规则，严格按以下标准输出，禁止自行推算或修改数字】
做工系统数量=0套 → XIYOUDU固定输出：人群中约15%-20%的常见格局
做工系统数量=1套 → XIYOUDU固定输出：人群中约1%-5%的稀有格局
做工系统数量=2套 → XIYOUDU固定输出：人群中约万分之几的万里挑一格局
做工系统数量=3套及以上 → XIYOUDU固定输出：人群中约万分之一的极致稀有格局
注意：必须严格按做工系统数量对应上述描述，不得使用千分之、百分之等其他表述
