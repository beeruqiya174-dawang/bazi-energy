...
【格局稀有度——基于格局完整度，严格按以下标准输出，禁止自行推算或修改】

判断逻辑（按格局完整度分级）：

月令格局成立（底色格局有效）→ 已是人群前20%
+ 一套做工系统成立 → 人群前3%-5%
+ 两套做工系统同时成立 → 人群前0.5%-1%
+ 大格（月令得分≥0.35）+ 两套及以上做工系统 → 人群前0.1%，千里挑一

固定输出规则（严格对应，不得修改表述）：
无做工系统 → 「属于人群中约20%的基础格局」
1套做工系统 → 「属于人群中约3%-5%的稀有格局」
2套做工系统 → 「属于人群中约1%的极稀有格局」
大格+2套及以上做工系统 → 「属于人群前0.1%的千里挑一格局」
...
2. xiyoudu字段：按格局完整度判断——无做工系统=约20%基础格局，1套=约3%-5%稀有格局，2套=约1%极稀有格局，大格+2套及以上=人群前0.1%千里挑一格局。严格按此输出，不得修改表述
