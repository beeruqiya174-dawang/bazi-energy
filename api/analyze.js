...
- 若 genqi_cengci.congge 为 true（无根无气但财官双全）：必须点明这是从格——弃命从财官，不担而顺，反主大富大贵的极少数
...
function templateJieda(r) {
  ...
  if (gc) {
    if (gc.congge) {
      parts.push('日主无根无气而财官双全——弃命从财官的从格：不担而顺，随财官之势而行。全枚举518,400盘中仅0.16%的极少数配置，古籍所谓「从得真者大富贵」正是此局。');
    } else {
      const gcText = {
